...
const cloudinaryController = require('../app/controllers/MiddlewareUploadConTroller')
...
router.post('/create', middlewareController.verifytokenandAdmin, cloudinaryController.upload, taiKhoanController.create)
